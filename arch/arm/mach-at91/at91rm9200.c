...
static struct at91_gpio_bank at91rm9200_gpio[] = {
	{
		...
		.regbase	= (void __iomem *)AT91_VA_BASE_SYS + AT91RM9200_PIOB,
		.clock		= &pioB_clk,
	}, {
		.id		= AT91RM9200_ID_PIOC,
		.regbase	= (void __iomem *)AT91_VA_BASE_SYS + AT91RM9200_PIOC,
		.clock		= &pioC_clk,
	}, {
		.id		= AT91RM9200_ID_PIOD,
		.regbase	= (void __iomem *)AT91_VA_BASE_SYS + AT91RM9200_PIOD,
		.clock		= &pioD_clk,
	}
};
...
{
	void __iomem* aic = (void __iomem *)AT91_VA_BASE_SYS + AT91RM9200_AIC;
