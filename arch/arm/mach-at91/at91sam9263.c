...
static struct at91_gpio_bank at91sam9263_gpio[] = {
	{
		...
		.regbase	= (void __iomem *)AT91_VA_BASE_SYS + AT91SAM9263_PIOA,
		.clock		= &pioA_clk,
	}, {
		.id		= AT91SAM9263_ID_PIOB,
		.regbase	= (void __iomem *)AT91_VA_BASE_SYS + AT91SAM9263_PIOB,
		.clock		= &pioB_clk,
	}, {
		.id		= AT91SAM9263_ID_PIOCDE,
		.regbase	= (void __iomem *)AT91_VA_BASE_SYS + AT91SAM9263_PIOC,
		.clock		= &pioCDE_clk,
	}, {
		.id		= AT91SAM9263_ID_PIOCDE,
		.regbase	= (void __iomem *)AT91_VA_BASE_SYS + AT91SAM9263_PIOD,
		.clock		= &pioCDE_clk,
	}, {
		.id		= AT91SAM9263_ID_PIOCDE,
		.regbase	= (void __iomem *)AT91_VA_BASE_SYS + AT91SAM9263_PIOE,
		.clock		= &pioCDE_clk,
	}
};
...
{
	void __iomem* aic = (void __iomem *)AT91_VA_BASE_SYS + AT91SAM9263_AIC;
