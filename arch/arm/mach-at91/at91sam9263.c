...
{
	at91_init_shdwc(AT91SAM9263_BASE_SHDWC);
	at91sam926x_timer_init(AT91SAM9263_BASE_PIT);
	sam9_smc_init(0, AT91SAM9263_BASE_SMC0);
	sam9_smc_init(1, AT91SAM9263_BASE_SMC1);
}
