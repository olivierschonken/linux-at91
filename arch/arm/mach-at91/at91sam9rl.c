...
static struct at91_gpio_bank at91sam9rl_gpio[] = {
	{
		...
		.regbase	= (void __iomem *)AT91_VA_BASE_SYS + AT91SAM9RL_PIOA,
		.clock		= &pioA_clk,
	}, {
		.id		= AT91SAM9RL_ID_PIOB,
		.regbase	= (void __iomem *)AT91_VA_BASE_SYS + AT91SAM9RL_PIOB,
		.clock		= &pioB_clk,
	}, {
		.id		= AT91SAM9RL_ID_PIOC,
		.regbase	= (void __iomem *)AT91_VA_BASE_SYS + AT91SAM9RL_PIOC,
		.clock		= &pioC_clk,
	}, {
		.id		= AT91SAM9RL_ID_PIOD,
		.regbase	= (void __iomem *)AT91_VA_BASE_SYS + AT91SAM9RL_PIOD,
		.clock		= &pioD_clk,
	}
};
...
{
	void __iomem* aic = (void __iomem *)AT91_VA_BASE_SYS + AT91SAM9RL_AIC;
