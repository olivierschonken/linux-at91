...
#define AT91_SDRAMC_MR		0x90			/* Mode Register */
...
#define AT91_SDRAMC_TR		0x94			/* Refresh Timer Register */
#define		AT91_SDRAMC_COUNT	(0xfff << 0)		/* Refresh Timer Count */

#define AT91_SDRAMC_CR		0x98			/* Configuration Register */
...
#define AT91_SDRAMC_SRR		0x9c			/* Self Refresh Register */
#define AT91_SDRAMC_LPR		0xa0			/* Low Power Register */
#define AT91_SDRAMC_IER		0xa4			/* Interrupt Enable Register */
#define AT91_SDRAMC_IDR		0xa8			/* Interrupt Disable Register */
#define AT91_SDRAMC_IMR		0xac			/* Interrupt Mask Register */
#define AT91_SDRAMC_ISR		0xb0			/* Interrupt Status Register */
